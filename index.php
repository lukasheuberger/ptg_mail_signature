...
<head>
    ...
    <title>Pfadi Thurgau Signature Generator</title>
...
<div id="wrap" class="pinnacle-wrapper">
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                Pfadi Thurgau Signature Generator
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="page-header">
            <h1 class="main-header"> Pfadi Thurgau Signature Generator</h1>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select id="equipe" name="Sender[equipe]">
                            <option value="Biber- und Wolfsstufenequipe">Biber- und Wolfsstufenequipe</option>
                            <option value="Pfadistufenequipe">Pfadistufenequipe</option>
                            <option value="Pio- und Roverstufenequipe">Pio- und Roverstufenequipe</option>
                            <option value="Anlassequipe">Anlassequipe</option>
                            <option value="Ausbildungsequipe">Ausbildungsequipe</option>
                            <option value="Betreuungsequipe">Betreuungsequipe</option>
                            <option value="Infoequipe">Infoequipe</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="function" name="Sender[function]">
                            ...
                            <option value="Kantonsleitung">Kantonsleitung</option>
                        </select>
                    </div>
                </div>
